...
dlprof --mode=pytorch --reports=iteration  --iter_start=30 --iter_stop=129  --force true --output_path outputs/$MODEL-$GPUS-$BATCH  python ./main.py --arch $MODEL -b $BATCH --training-only -p 10 --prof 140 --epochs 1 --prof-output outputs/$MODEL-$GPUS-$BATCH/  /home/shared/ILSVRC2012/
